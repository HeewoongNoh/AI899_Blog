...
However, the authors observed that KL regularization alone may cause over-pruning in the latent space. To address this, a post-hoc normalizing flow is applied using Conditional Flow Matching (Lipman et al., 2023), specifically the minibatch optimal transport variant (Tong et al., 2024).
